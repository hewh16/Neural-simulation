function [IndexofCentrifugalOrder,CentrifugalOrder,IndexBasedonCentrifugalOrder,NSegments]=CentrifugalOrderDenefinition(NeededNeurite,CControalBranchingMemory)         
...
UsedforNSegments=cellfun('isempty',NeededNeurite);
