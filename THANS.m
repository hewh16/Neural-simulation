...
ExperimentTimes=148;  % This is the iteration number of the experiment part.
EnvelopeType=1;
...
if FormalExperimentType==1
    ...
    for IDIteration=1:ExperimentTimes-1
        ...
        if IDIteration>2
           ...
           [CellofNeuritesAcrossTime,TheNeuritesofSomas,TheNeuritesofEachSoma]=DefineTheStructureofNeurites(IterationCellofInfluxSpace,MulitDPofLamellipodiaCellAccrostheTime,InitializedInformation,InformationInitializedofSomas,IDIteration);
            %% Chemical Substances and Neurites Development
%            []=ChemicalSystemandNeuralDevelopment(CellofNeuritesAcrossTime,StructureofChemicalandDevelopment,BasicSettingsforChemical,IDIteration,BasicSettings);
%             %% 
% 
%             %%
% 
